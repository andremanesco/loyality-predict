...
tb_agg_transacao AS (
    SELECT IdCliente,
        ...
        COUNT(DISTINCT CASE WHEN IdTransacao > date('2025-10-01', '-7 days') THEN IdTransacao END) AS qtdeTransacaoD7,
        COUNT(DISTINCT CASE WHEN IdTransacao > date('2025-10-01', '-14 days') THEN IdTransacao END) AS qtdeTransacaoD14,
        COUNT(DISTINCT CASE WHEN IdTransacao > date('2025-10-01', '-28 days') THEN IdTransacao END) AS qtdeTransacaoD28,
        COUNT(DISTINCT CASE WHEN IdTransacao > date('2025-10-01', '-56 days') THEN IdTransacao END) AS qtdeTransacaoD56,
        ...
        SUM(CASE WHEN dtDia > date('2025-10-01', '-7 days') AND qtdePontos > 0 THEN  qtdePontos ELSE 0 END) AS qtdPontosPositivosD7,
        SUM(CASE WHEN dtDia > date('2025-10-01', '-14 days') AND qtdePontos > 0 THEN qtdePontos ELSE 0 END) AS qtdPontosPositivosD14,
        SUM(CASE WHEN dtDia > date('2025-10-01', '-28 days') AND qtdePontos > 0 THEN qtdePontos ELSE 0 END) AS qtdPontosPositivosD28,
        SUM(CASE WHEN dtDia > date('2025-10-01', '-56 days') AND qtdePontos > 0 THEN qtdePontos ELSE 0 END) AS qtdPontosPositivosD56,

        SUM(CASE WHEN qtdePontos < 0 THEN qtdePontos ELSE 0 END) AS qtdPontosNegativosVida,
        SUM(CASE WHEN dtDia < date('2025-10-01', '-7 days') AND qtdePontos < 0 THEN  qtdePontos ELSE 0 END) AS qtdPontosNegativosD7,
        SUM(CASE WHEN dtDia < date('2025-10-01', '-14 days') AND qtdePontos < 0 THEN qtdePontos ELSE 0 END) AS qtdPontosNegativosD14,
        SUM(CASE WHEN dtDia < date('2025-10-01', '-28 days') AND qtdePontos < 0 THEN qtdePontos ELSE 0 END) AS qtdPontosNegativosD28,
        SUM(CASE WHEN dtDia < date('2025-10-01', '-56 days') AND qtdePontos < 0 THEN qtdePontos ELSE 0 END) AS qtdPontosNegativosD56,
...
tb_intervalo_dias AS (
    SELECT 
        ...
        AVG(CASE WHEN dtDia >= date('2025-10-01', '-28 days') THEN julianday(dtDia) - julianday(lagDia) END) AS avgIntervaloDiasD28
    FROM tb_lag_dia
    GROUP BY IdCliente
),
...
SELECT date('2025-10-01', '-1 day') AS dtReferencia,
    *
FROM tb_join